...
export const CONFIG_FIELDS = {
  ...
  showReplyContext: {
    ...
    title:
      'If checked, the post being replied to will be shown even if it was previously marked as read.',
    type: 'checkbox',
    default: false,
  },
  unrollThreads: {
    ...
    title:
      'If checked, threads with one or more replies from the original author will be "unrolled" into the first post.',
    type: 'checkbox',
    default: false,
  },
  ...
  showReplySidecar: {
    ...
    title:
      'If checked, replies to the selected post (and, where applicable, the post being replied to) will be displayed in a sidecar next to each post (requires atproto settings below).',
    type: 'checkbox',
    default: false,
  },
  ...
  hideRightSidebar: {
    ...
    title:
      'If checked, the right sidebar with the search box, following/trending displays, etc. will be hidden (useful when overriding max width above).',
    type: 'checkbox',
    default: false,
  },
  hideLoadNewButton: {
  ...
  disableLoadMoreOnScroll: {
    ...
    title:
      'If checked, the default behavior of loading more items when scrolling will be disabled. You can still press "U" to load more manually.',
    type: 'checkbox',
    default: false,
  },
  savePostState: {
